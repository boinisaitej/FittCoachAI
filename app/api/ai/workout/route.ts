...
import { generateWorkoutDay, generateWorkoutWeek } from "@/lib/ai";
...
export async function POST(req: Request) {
  ...
  const result = body.scope === "week" ? await generateWorkoutWeek(ctx, start) : await generateWorkoutDay(ctx, start);
